...
module.exports = {
	...
	targets: {
        ...
        './assets/src/common/directives/index.coffee': { template: 'assets/src/common/directives/index.coffee' },
        ...
        './assets/index.html': { template: 'assets/index.html' },
        ...
        './config/ngwebserver.js': { template: 'config/ngwebserver.js' },
